"""
AI/Data Science focused tweet generator that posts to Twitter
"""
...
def test_main(actually_post=False):
    ...
    try:
        ...
        logging.info("Generating AI/data science tweet...")
        final_message = perplexity_client.generate_ai_tweet(last_tweets)
...
def main():
    """Main function to generate and post an AI/data science focused tweet"""
    try:
        # Get Supabase client
        supabase = config.get_supabase_client()
